...
func init() {
	...
	url := flag.String("u", "ws://127.0.0.1:7777", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "robot", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "ATRI", "atri", "亚托莉", "アトリ","bot"),
